...
tripletDictionary[HHH]="$HHH_Percentage"
tripletDictionary[HHT]="$HHT_Percentage"
tripletDictionary[HTH]="$HTH_Percentage"
tripletDictionary[THH]="$THH_Percentage"
tripletDictionary[TTH]="$TTH_Percentage"
tripletDictionary[THT]="$THT_Percentage"
tripletDictionary[HTT]="$HTT_Percentage"
tripletDictionary[TTT]="$TTT_Percentage"
